...
if [[ "$CKPT_TYPE" == "ours" ]]; then
    ckpt_path=${DATA_ROOT}/beyond_vmr_models/CGDETR/anet/results_no_sa_masked_qd_0,25_bsz_16_lr_1e-4/hl-txt_original/model_best.ckpt
else
    # default to standard
    ckpt_path=${DATA_ROOT}/beyond_vmr_models/CGDETR/anet/results_standard_ce/hl-txt_original/model_best.ckpt
fi
