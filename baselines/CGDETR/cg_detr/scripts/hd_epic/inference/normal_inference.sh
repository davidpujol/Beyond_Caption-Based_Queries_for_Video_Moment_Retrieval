...
if [[ "$CKPT_TYPE" == "ours" ]]; then
    ckpt_path=${DATA_ROOT}/beyond_vmr_models/CGDETR/hd_epic/results_hd_epic_no_sa_qd_0,25/hd_epic-txt_original/model_best.ckpt
else
    # default to standard
    ckpt_path=${DATA_ROOT}/beyond_vmr_models/CGDETR/hd_epic/results_hd_epic_standard_ce/hd_epic-txt_original/model_best.ckpt
fi
