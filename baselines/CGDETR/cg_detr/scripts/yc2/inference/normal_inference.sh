...
if [[ "$CKPT_TYPE" == "ours" ]]; then
    ckpt_path=${DATA_ROOT}/beyond_vmr_models/CGDETR/yc2/results_yc2_no_sa_qd_0,25/yc2-txt_original/model_best.ckpt
else
    # default to standard
    ckpt_path=${DATA_ROOT}/beyond_vmr_models/CGDETR/yc2/results_yc2_standard_ce/yc2-txt_original/model_best.ckpt
fi
