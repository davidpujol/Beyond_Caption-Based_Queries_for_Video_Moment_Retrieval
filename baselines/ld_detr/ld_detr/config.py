...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--discard_dir", type=str, default=None, help="Directory with the photos of the queries to use for discarding")
        ...
        parser.add_argument("--n_epoch", type=int, default=175, help="number of epochs to run")
