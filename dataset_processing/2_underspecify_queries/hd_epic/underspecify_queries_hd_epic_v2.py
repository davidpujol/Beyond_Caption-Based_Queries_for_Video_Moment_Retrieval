...
def simplify_query(query: str) -> str:
    prompt = f"""Simplify this query by removing or generalizing unnecessary information, but keeping the sentence’s meaning.  
    ...
    Simplified query: Switch the button. 
...
# Usage HD-EPIC:
# python dataset_processing/datasets_augmentation_generation/underspecified_queries/hd_epic/underspecify_queries_hd_epic.py ${DATA_ROOT}/HD_EPIC/HD_EPIC_Narrations.pkl ${DATA_ROOT}/HD_EPIC/underspecified/full_simplification