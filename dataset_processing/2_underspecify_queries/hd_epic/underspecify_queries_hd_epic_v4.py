...
def simplify_query(query: str) -> str:
    ...
    Simplied query: Turn something on.
...
# Usage HD-EPIC:
# python dataset_processing/datasets_augmentation_generation/underspecified_queries/hd_epic/underspecify_queries_hd_epic_v4.py ${DATA_ROOT}/HD_EPIC/HD_EPIC_Narrations.pkl ${DATA_ROOT}/HD_EPIC/underspecified/full_simplification_v4